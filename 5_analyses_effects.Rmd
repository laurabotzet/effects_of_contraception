...
#### Summary
```{r}
kable(tidy(m_hc_sexfreq, intervals = T, prob = 0.90))
summary(m_hc_sexfreq, intervals = T, prob = 0.90)
```

#### Comparison with ROPE
```{r}
plot(equivalence_test(m_hc_sexfreq, range = c(-0.05, 0.05), ci = 0.90,
                      parameters = "contraception"))
equivalence_test(m_hc_sexfreq, range = c(-0.05, 0.05), ci = 0.90,
                      parameters = "contraception")
```

#### Plots
```{r}
conditional_effects(m_hc_sexfreq,
                    effects = "contraception_hormonal",
                    conditions = data.frame(number_of_days = 1))
```
...
#### Summary
```{r}
kable(tidy(m_hc_sexfreq_controlled, intervals = T, prob = 0.90))
summary(m_hc_sexfreq_controlled, intervals = T, prob = 0.90)
```

#### Comparison with ROPE
```{r}
plot(equivalence_test(m_hc_sexfreq_controlled, range = c(-0.05, 0.05), ci = 0.90,
                      parameters = "contraception"))
equivalence_test(m_hc_sexfreq_controlled, range = c(-0.05, 0.05), ci = 0.90,
                      parameters = "contraception")
```

#### Plots
```{r}
conditional_effects(m_hc_sexfreq_controlled,
                    effects = "contraception_hormonal",
                    conditions = data.frame(number_of_days = 1))
```
...
#### Summary
```{r}
kable(tidy(m_congruency_sexfreq, intervals = T, prob = 0.90))
summary(m_congruency_sexfreq, intervals = T, prob = 0.90)
```

#### Comparison with ROPE
```{r}
plot(equivalence_test(m_congruency_sexfreq, range = c(-0.05, 0.05), ci = 0.90,
                      parameters = "contraception"))
equivalence_test(m_congruency_sexfreq, range = c(-0.05, 0.05), ci = 0.90,
                      parameters = "contraception")
```

#### Plots
```{r}
conditional_effects(m_congruency_sexfreq,
                    effects = "contraception_hormonal:congruent_contraception",
                    conditions = data.frame(number_of_days = 1))
```
...
#### Summary
```{r}
kable(tidy(m_congruency_sexfreq_controlled, intervals = T, prob = 0.90))
summary(m_congruency_sexfreq_controlled, intervals = T, prob = 0.90)
```

#### Comparison with ROPE
```{r}
plot(equivalence_test(m_congruency_sexfreq_controlled, range = c(-0.05, 0.05), ci = 0.90,
                      parameters = "contraception"))
equivalence_test(m_congruency_sexfreq_controlled, range = c(-0.05, 0.05), ci = 0.90,
                      parameters = "contraception")
```

#### Plots
```{r}
conditional_effects(m_congruency_sexfreq_controlled,
                    effects = "contraception_hormonal:congruent_contraception",
                    conditions = data.frame(number_of_days = 1))
```

...
#### Model
```{r}
m_hc_sexfreq = glm(diary_sex_active_sum ~
                        offset(log(number_of_days)) +
                        contraception_hormonal_numeric +
                        age + net_income + relationship_duration_factor +
                              education_years +
...
#### Sensitivity Analyses
```{r}
m_hc_sexfreq_sensitivity <- sensemakr(estimate = -0.00378,
                                         se = 0.0172,
                                         dof = 949,
                                         treatment = "contraception_hormonal_numeric",
                                         benchmark_covariates = covariates, #covariates that will be
...
m_hc_sexfreq_sensitivity
summary(m_hc_sexfreq_sensitivity)
```

#### Plots
```{r}
plot(m_hc_sexfreq_sensitivity)
plot(m_hc_sexfreq_sensitivity, sensitivity.of = "t-value")
plot(m_hc_sexfreq_sensitivity, type = "extreme")
```
...
#### Model
```{r}
m_con_sexfreq = glm(diary_sex_active_sum ~
                        offset(log(number_of_days)) +
                        contraception_hormonal_numeric + congruent_contraception_numeric +
                         hc_con_interaction + 
                        age + net_income + relationship_duration_factor +
...
##### HC
```{r}
m_con_sexfreq_sensitivity_hc <- sensemakr(estimate = -0.0423,
                                         se = 0.0327,
                                         dof = 612,
                                         treatment = "contraception_hormonal_numeric",
                                         benchmark_covariates = covariates, #covariates that will be
...
m_con_sexfreq_sensitivity_hc
summary(m_con_sexfreq_sensitivity_hc)
```


##### Congruency
```{r}
m_con_sexfreq_sensitivity_con <- sensemakr(estimate = -0.00108,
                                         se = 0.0279,
                                         dof = 612,
                                         treatment = "congruent_contraception_numeric",
                                         benchmark_covariates = covariates, #covariates that will be
...
m_con_sexfreq_sensitivity_con
summary(m_con_sexfreq_sensitivity_con)
```

##### Interaction
```{r}
m_con_sexfreq_sensitivity_interaction <- sensemakr(estimate = 0.0600,
                                         se = 0.0406,
                                         dof = 612,
                                         treatment = "hc_con_interaction",
                                         benchmark_covariates = covariates, #covariates that will be
...
m_con_sexfreq_sensitivity_interaction

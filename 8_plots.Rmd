...
jpeg('Effect size estimates for models with current contraceptive use as an outcome REVISED.jpg', 
...
selection_congruent
jpeg('Effect size estimates for models with congruency in contraceptive method as an outcome REVISED.jpg', 
...
hc_plots
jpeg('Effect size estimates for hormonal contraceptives on outcomes REVISED.jpg', 
...
congruency_uncontrolled
jpeg('Differences in current contraceptive method, congruent use of contraceptive method, and their interaction REVISED.jpg', 
     width = 800, height = 1000, quality = 100)
congruency_uncontrolled
dev.off()
```
...
congruency_controlled
jpeg('Differences in current contraceptive method, congruent use of contraceptive method, and their interaction in controlled models REVISED.jpg', 
     width = 800, height = 1000, quality = 100)
congruency_controlled
dev.off()
```

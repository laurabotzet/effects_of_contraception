...
##### Sensitivity Analyses
```{r}
m_hc_sexfreqpen_sensitivity <- sensemakr(estimate = 0.3827,
                                         se = 0.0248,
                                         dof = 966,
...
##### Sensitivity Analyses
```{r}
m_hc_masfreq_sensitivity <- sensemakr(estimate = -0.3715,
                                         se = 0.0267,
                                         dof = 949,
                                         treatment = "contraception_hormonal_numeric",
                                         benchmark_covariates = covariates, #covariates that will be
...
###### HC
```{r}
m_con_sexfreqpen_sensitivity_hc <- sensemakr(estimate = 0.2090,
                                         se = 0.0444,
                                         dof = 628,
                                         treatment = "contraception_hormonal_numeric",
                                         kd = 1:3, #these arguments parameterize how many times
...
###### Congruency
```{r}
m_con_sexfreqpen_sensitivity_con <- sensemakr(estimate = 0.0548,
                                         se = 0.0390,
                                         dof = 628,
...
###### Interaction
```{r}
m_con_sexfreqpen_sensitivity_interaction <- sensemakr(estimate = -0.0533,
                                         se = 0.0552,
                                         dof = 628,
...
###### HC
```{r}
m_con_masfreq_sensitivity_hc <- sensemakr(estimate = -0.3758,
                                         se = 0.0577,
                                         dof = 628,
                                         treatment = "contraception_hormonal_numeric",
                                         kd = 1:3, #these arguments parameterize how many times
...
###### Congruency
```{r}
m_con_masfreq_sensitivity_con <- sensemakr(estimate = 0.0824,
                                         se = 0.0709,
                                         dof = 628,
                                         treatment = "congruent_contraception_numeric",
                                         kd = 1:3, #these arguments parameterize how many times
...
###### Interaction
```{r}
m_con_masfreq_sensitivity_interaction <- sensemakr(estimate = 0.0824,
                                         se = 0.0428,
                                         dof = 628,
                                         treatment = "hc_con_interaction",
                                         kd = 1:3, #these arguments parameterize how many times

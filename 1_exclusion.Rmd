...
all_surveys$reasons_for_exclusion_contraception = "" #insert new variable reasons_for_exclusion to list all exclusion criteria
```
...
```
In total 469 participants were excluded, leaving 1191 subjects which were included in the analysis.

...
```{r}
crosstabs(~ high_libido + sexual_desire_for_whom, data = data_diary)
...
qplot(data_diary_means$diary_libido_solitary_mean)
qplot(data_diary_means$diary_libido_dyadic_mean)

...
m_selection_congruent_simple_includinghc = brm(congruent_contraception ~
                              (age + net_income + relationship_duration_factor) *
                                as.factor(contraception_meeting_partner),
                            data = data,
                            family = bernoulli("probit"),
...
#### Comparison {.active}
```{r}
compare_models = loo(m_selectm_selection_congruent_simple_includinghc,
                     m_selection_congruent_complex_includingHC)
```
LooIC first model: `r round(compare_models$loos$m_selectm_selection_congruent_simple_includinghc$estimates[3,1], 2)`
